...
Flight::set("imageLimit", $_POST['limit']);
...
Flight::set("sql_all_images", "SELECT * FROM images ORDER BY uploaded_on " . Flight::get("sorting") . " LIMIT " . Flight::get("imageLimit") . ", 10;");
Flight::set("sql_liked_images", "SELECT * FROM images WHERE image_id IN (SELECT image_id FROM likes WHERE user_id='" . $_SESSION["id"] . "') ORDER BY uploaded_on " . Flight::get("sorting") . " LIMIT " . Flight::get("imageLimit") . ", 10;");
Flight::set("sql_profile_images", "SELECT * FROM images WHERE user_id = " . $_SESSION['id'] . " ORDER BY uploaded_on " . Flight::get("sorting") . " LIMIT " . Flight::get("imageLimit") . ", 10;");
